...
time.sleep(5)
all_role = len(driver.find_elements(By.XPATH, "//div[@class='oxd-table-body']//div[@class='oxd-table-row "
                                              "oxd-table-row--with-border']//div[3]"))
print("All the user role", all_role)

count = 0
for r in range(1, all_role + 1):
    roles = driver.find_element(By.XPATH,
                                "//*[@id='app']/div[1]/div[2]/div[2]/div/div[2]/div[3]/div/div[2]/div[" + str(
                                    r) + "]//div[3]").text

    if roles == "ESS":
        driver.find_element(By.XPATH, "//*[@id='app']/div[1]/div[2]/div[2]/div/div[2]/div[3]/div/div[2]/div[" + str(
            r) + "]//div[2]")
        count = count + 1
print("Total no of ESS roles:", count)
print("Total no of other roles:", (all_role - count))
